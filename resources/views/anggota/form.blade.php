                    ...
                    <div class="card-body">
                        <div class="row mb-5">
                            <div class="col-lg-12">
                                    ...
                                    <div class="container">
                                        <form action="{{route('anggota.store')}}" method="POST" enctype="multipart/form-data" class="user" >
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 mt-4">
                                                    <div class="form-group">
                                                        <strong></strong>
                                                        <input type="text" name="kampus" class="form-control form-control-user"  placeholder="Kampus">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12 mt-4">
                                                    <div class="form-group">
                                                        <strong></strong>
                                                        <input type="text" name="hp"  class="form-control form-control-user" placeholder="No Hp">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-12 col-md-12 mt-4">
                                                    <div class="form-group">
