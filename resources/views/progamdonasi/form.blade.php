                ...
                <div class="card shadow-lg ">
                    <div class="card-body">
                        <div class="row mb-5">
                         ...
                         <form method="POST" action="{{ route('progamdonasi.store') }}" enctype="multipart/form-data">
                            @csrf
                                 ...
                                 <div class="row">
                                      <div class="col-md-6">
                                        ...
                                        <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="nama" required autocomplete="nama" autofocus>
                                        ...
                                        @enderror
                                         ...
                                         <div class="col-md-6">
                                            ...
                                            <input id="tanggal akhir donasi" type="date" class="form-control @error('tanggal akhir donasi') is-invalid @enderror" name="tgl_berakhir"  required autocomplete="tanggal akhir donasi" autofocus>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="nomer rekening" type="text" class="form-control @error('nomer rekening') is-invalid @enderror" name="no_rekening" required autocomplete="nomer rekening">
                                    ...
                                    <div class="col-md-12 mt-5">
                                                   ...
                                                   <div class="form">
                                                      <div class="form-floating">
                                                        <textarea class="form-control"  id="editor" name="deskripsi" lass="form-control @error('deskripsi') is-invalid @enderror"></textarea>
                            ...
                            <div class="pull-right">
                                    <a class="text-primary" href="{{route('progamdonasi.index')}}">Kemabali ke halaman berita</a>
                                    </div>
                        </form>
                    </div>
                    </div>
